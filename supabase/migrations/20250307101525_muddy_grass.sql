/*
  # Add T20 Blast 2025 Matches and Structure

  1. New Tables
    - `match_phases`
      - Tracks tournament phases (group stages, knockouts)
      - Links matches to specific tournament phases
      - Supports group-based tournament structure

    - `player_stats`
      - Records player performance metrics
      - Tracks runs, wickets, catches per match
      - Enables detailed player analytics

  2. Data Updates
    - Add T20 Blast tournament data
    - Add all 133 matches for the 2025 season
    - Include complete team and venue information
    - Set up group stage structure
...
-- Add public read access policy for match phases
...
-- Add public read access policy for player stats
